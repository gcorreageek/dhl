...
import com.hsn.serv.repository.UserPlusRepository;
import com.hsn.serv.service.UserPlusService;
...
public class UserPlusResourceIntTest {
    ...
    private static final Boolean DEFAULT_DISABLED_PERFIL = false;
    private static final Boolean UPDATED_DISABLED_PERFIL = true;
    ...
    public static UserPlus createEntity(EntityManager em) {
        ...
        userPlus.setDisabledPerfil(DEFAULT_DISABLED_PERFIL);
    ...
    public void createUserPlus() throws Exception {
        ...
        assertThat(testUserPlus.isDisabledPerfil()).isEqualTo(DEFAULT_DISABLED_PERFIL);
    ...
    public void getAllUserPluses() throws Exception {
        ...
        restUserPlusMockMvc.perform(get("/api/user-pluses?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].disabledPerfil").value(hasItem(DEFAULT_DISABLED_PERFIL.booleanValue())))
    ...
    public void getUserPlus() throws Exception {
        ...
        restUserPlusMockMvc.perform(get("/api/user-pluses/{id}", userPlus.getId()))
            ...
            .andExpect(jsonPath("$.disabledPerfil").value(DEFAULT_DISABLED_PERFIL.booleanValue()))
    ...
    public void updateUserPlus() throws Exception {
        ...
        updatedUserPlus.setDisabledPerfil(UPDATED_DISABLED_PERFIL);
        ...
        assertThat(testUserPlus.isDisabledPerfil()).isEqualTo(UPDATED_DISABLED_PERFIL);
