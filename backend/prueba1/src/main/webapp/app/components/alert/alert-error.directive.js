(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('prueba1App.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-prueba1App-error');
                var entityKey = httpResponse.headers('X-prueba1App-params');
                if (errorHeader) {
