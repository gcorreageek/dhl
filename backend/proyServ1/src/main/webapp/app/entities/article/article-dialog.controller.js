(function() {
    ...
    ArticleDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Article', 'ArticleHash', 'ArticleReaction', 'User'];

    function ArticleDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Article, ArticleHash, ArticleReaction, User) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('proyServ1App:articleUpdate', result);
