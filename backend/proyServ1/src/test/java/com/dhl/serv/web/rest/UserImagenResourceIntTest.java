...
public class UserImagenResourceIntTest {
    ...
    private static final String DEFAULT_USER_IMAGEN_TYPE = "AAAAA";
    private static final String UPDATED_USER_IMAGEN_TYPE = "BBBBB";
    ...
    public void setup() {
        ...
        ReflectionTestUtils.setField(userImagenResource, "userImagenRepository", userImagenRepository);
    ...
    public static UserImagen createEntity(EntityManager em) {
        ...
        userImagen.setUserImagenType(DEFAULT_USER_IMAGEN_TYPE);
        return userImagen;
    }
    ...
    public void createUserImagen() throws Exception {
        ...
        assertThat(testUserImagen.getUserImagenType()).isEqualTo(DEFAULT_USER_IMAGEN_TYPE);
    }
    ...
    public void getAllUserImagens() throws Exception {
        ...
        restUserImagenMockMvc.perform(get("/api/user-imagens?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].userImagenType").value(hasItem(DEFAULT_USER_IMAGEN_TYPE.toString())));
    }
    ...
    public void getUserImagen() throws Exception {
        ...
        restUserImagenMockMvc.perform(get("/api/user-imagens/{id}", userImagen.getId()))
            ...
            .andExpect(jsonPath("$.userImagenType").value(DEFAULT_USER_IMAGEN_TYPE.toString()));
    }
    ...
    public void updateUserImagen() throws Exception {
        ...
        updatedUserImagen.setUserImagenType(UPDATED_USER_IMAGEN_TYPE);
        ...
        assertThat(testUserImagen.getUserImagenType()).isEqualTo(UPDATED_USER_IMAGEN_TYPE);
    }
